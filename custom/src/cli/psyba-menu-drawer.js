...
export class PsybaMenuDrawer extends DDDSuper(I18NMixin(LitElement)) {
  ...
  constructor() {
    ...
    this.registerLocalization({
      context: this,
      localesPath:
        new URL("./locales/psyba-menu-drawer.ar.json", import.meta.url).href +
        "/../",
      locales: ["ar", "es", "hi", "zh"],
    });
  }
  ...
  static get styles() {
    ...
    css`
      ...
      h3 span {
        font-size: var(--psyba-menu-drawer-label-font-size, var(--ddd-font-size-s));
      }
    `];
  }
